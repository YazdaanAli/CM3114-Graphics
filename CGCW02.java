...
//			T.LookAt(0, 0, 0, 0, 0, -100, 0, 1, 0);  	//Default					
		...
		public void init(GLAutoDrawable drawable) {
			...
			float[] lightPosition2 = {10.0f, 15.0f, 20.0f, 1.0f};
			Vec4 lightAmbient2 = new Vec4(0.7f, 0.7f, 0.7f, 1.0f);
			...
			//Creating second object cone
			SObject cone = new SCone(5,4);
			idPoint=1;
			idBuffer=1;
			idElement=1;
			createObject(gl, cone);

			//Setting cone material
			Vec4 materialAmbient2 = new Vec4(0.1f, 0.18f, 0.17f, 0.8f);
			Vec4 materialDiffuse2= new Vec4(0.39f, 0.74f, 0.69f, 0.8f);
			Vec4 materialSpecular2 = new Vec4(0.29f, 0.3f, 0.3f, 0.8f);
