...
public class CGCW01{
	...
	class Renderer implements GLEventListener, KeyListener {
		...
		//Added parameters
		private float tx = 0; //Translate X
		private float ty = 0; //Translate Y
		private float rx = 0; // Rotate X
		private float ry = 0; //Rotate Y
...
//		    gl.glDepthFunc(GL_LESS);
		...
		public void keyPressed(KeyEvent ke) {
			...
			switch (keyEvent) {
				...
				case KeyEvent.VK_LEFT -> tx += 0.01;
				case KeyEvent.VK_RIGHT -> tx -= 0.01;
				case KeyEvent.VK_UP -> ty -= 0.01;
				case KeyEvent.VK_DOWN -> ty += 0.01;
